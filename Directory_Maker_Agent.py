...
class DirectoryStructureAgent:
    ...
    def __init__(self, openai_api_key: str, example_repo_index=None, cache_db_path="cache.json"):
        """
    ...
    def _generate_with_openai(self, prompt: str) -> Optional[str]:
        ...
        try:
            response = self.openai_client.chat.completions.create(
                model="gpt-3.5-turbo",  # Using GPT-4o-mini for cost efficiency and good performance
                messages=[
                    {
                        "role": "system",
